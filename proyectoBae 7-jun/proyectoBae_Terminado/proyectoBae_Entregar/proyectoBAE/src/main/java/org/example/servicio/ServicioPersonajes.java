...
public class ServicioPersonajes {
    ...
    public void crearPersonaje(String nombre, String anime){
        Personajes personajes = new Personajes(nombre, anime);
    ...
    public void actualizarPersonaje(String id, String nombre, String anime){
        Personajes personajeActualizado = new Personajes(nombre, anime);
